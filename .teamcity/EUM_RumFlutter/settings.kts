...
AppdBuildSettings.Builder(AppdBuild.PipeLibType.JAVA_LIB)
        ...
        .simpleParams("env.MD_APPLE_SDK_ROOT" to "/Applications/Xcode-14.2.app/","env.SONAR_HOST_URL" to "%env.SONAR_BARE_HOST_URL%", "env.SONAR_LOGIN" to "%env.SONAR_BARE_LOGIN%", "env.JAVA_HOME" to "/Library/Java/JavaVirtualMachines/temurin-17.jdk/Contents/Home")
        .passwordParams()
        .checkboxParams()
        .selectParams()
